...
track-not-found = This track was not downloaded via { $brand }.
btn-album = Album
btn-artist = Artist
...
feature-entity-tracks = Track list for this entity
...
entity-truncated = Too many tracks here — downloading the first { $limit }.
batch-already-running = I'm still downloading your previous album. Wait until it's done.
bot-busy = I'm downloading several albums right now, try again in a couple of minutes.

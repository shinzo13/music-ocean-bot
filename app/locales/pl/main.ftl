...
downloaded = Pobrano!
entity-truncated = Za dużo utworów — pobieram pierwsze { $limit }.
batch-already-running = Wciąż pobieram twój poprzedni album. Poczekaj, aż skończę.
bot-busy = Pobieram teraz kilka albumów naraz, spróbuj za parę minut.

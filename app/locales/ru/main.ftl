...
mailing-restricted-content-type = <i>Такой тип контента нельзя разослать, отправьте другое сообщение.</i>
mailing-approve-message = <i>Разослать это всем пользователям?</i>
...
downloaded = Скачано!
entity-truncated = Тут слишком много треков — качаю первые { $limit }.
batch-already-running = Я ещё качаю твой прошлый альбом. Дождись, пока закончу.
bot-busy = Сейчас качаю сразу несколько альбомов, попробуй через пару минут.
btn-search-for-track = Найти трек
btn-download-all = Скачать все треки
btn-downloading = Скачиваю...
btn-click-to-download = Нажми, чтобы скачать
...
error-track-too-large = Файл больше 50 МБ — телеграм не пропускает такие. Обычно это длинная запись, а не трек.
...
## top
top-title = 🏆 <b>Топ по загрузкам</b>
top-empty = Пока никто ничего не скачал.

## moderation
unban-notice = 🔓 <b>Тебя разбанили.</b> Ботом снова можно пользоваться — с возвращением!
